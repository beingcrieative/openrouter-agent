...
<!--
URL: https://openrouter.ai/docs/parameters
title: Parameters | OpenRouter
url: https://openrouter.ai
hostname: openrouter.ai
description: Configure parameters for requests
sitename: OpenRouter
date: 2023-01-01
categories: []
tags: []
image: https://openrouter.ai/dynamic-og?pathname=docs%2Fparameters&title=Parameters&description=Configure+parameters+for+requests
filedate: 2024-12-14
-->
